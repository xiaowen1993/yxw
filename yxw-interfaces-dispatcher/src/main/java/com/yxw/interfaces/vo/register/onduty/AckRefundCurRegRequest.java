...
public class AckRefundCurRegRequest extends Reserve implements Serializable {

	private static final long serialVersionUID = 5180068112498678256L;
	/**
	...
	public AckRefundCurRegRequest(String branchCode, String hisOrdNum, String psOrdNum, String refundMode, String refundAmout) {
		super();
