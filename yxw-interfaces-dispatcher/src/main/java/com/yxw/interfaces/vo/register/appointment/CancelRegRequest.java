...
public class CancelRegRequest extends Reserve implements Serializable {

	private static final long serialVersionUID = -8699111737711513536L;
	/**
	...
	public CancelRegRequest(String branchCode, String hisOrdNum, String psOrdNum, String cancelMode, String cancelTime, String cancelReason) {
		super();
