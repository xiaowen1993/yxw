 ...
 * @Version: 1.0
 */
public class OrdersQueryResult implements Serializable {
	/**
	 * 
	 */
	...
	public OrdersQueryResult(String tradeTime, String orderMode, String tradeMode, String psPayOrdNum, String psRefundOrdNum, String hisPayOrdNum,
