		...
		<div class="row">
			<div class="col-sm-1 col-md-1 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="/orderCount"><i class="fa fa-area-chart fa-lg"></i>&nbsp;&nbsp;订单量</a></li>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form class="form-inline" role="form">
								...
								<div class="btn-group">
									<div class="btn btn-default dropdown-toggle" data-toggle="dropdown">
										<span class="text">累计</span> <span class="caret"></span>
									</div>
									<ul class="dropdown-menu" role="menu" id="statsTypeList" data-value="1">
										<li data-value="1"><a href="javascript: void(0);">累计</a></li>
										<li data-value="2"><a href="javascript: void(0);">每月</a></li>
									</ul>
								</div>
