		...
		<div class="row">
			<div class="col-sm-1 col-md-1 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="/hospital"><i class="fa fa-hospital-o fa-lg"></i>&nbsp;&nbsp;医院数据</a></li>
			...
			<div class="col-sm-11 col-sm-offset-1 col-md-11 col-md-offset-1 main">
				...
				<div class="row placeholders">
					<div class="col-md-12 placeholder">
						<div><span class="title">医院上线情况图</span></div>
						<div class="hospitalChart" style="width: 100%; height: 400px;"></div>
					</div>
					<hr />
					<div class="col-md-12 placeholder">
						<div>
							<span class="title">医院上线情况表</span>
