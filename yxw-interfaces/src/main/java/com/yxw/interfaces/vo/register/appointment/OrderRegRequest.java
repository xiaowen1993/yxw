...
public class OrderRegRequest extends Reserve implements Serializable {
	...
	/**
	 * 参保类型  0.不参加 1.综合医保 2.住院医保
	 * */
	private String sSCblx;
	
	/**
	 * 社保电脑号
	 * */
	private String sSComputerNumber;
	...
	public String getsSCblx() {
		return sSCblx;
	}

	public void setsSCblx(String sSCblx) {
		this.sSCblx = sSCblx;
	}

	public String getsSComputerNumber() {
		return sSComputerNumber;
	}

	public void setsSComputerNumber(String sSComputerNumber) {
		this.sSComputerNumber = sSComputerNumber;
	}
