...
public class ReplaceReg extends Reserve implements Serializable {
	 ...
	 */
	public ReplaceReg(String hisOrdNum, String psOrdNum, String deptCode, String deptName, String doctorCode, String doctorName, String reason,
                      String beginTime, String endTime, String replaceDoctorName) {
		super();
