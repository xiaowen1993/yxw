...
/**
 * 检验/检查/体检报告查询-->检查结果列表请求参数封装
 * @Package: com.yxw.interfaces.entity.inspection
 * @ClassName: ExamineRequest
 * @Statement: <p></p>
 * @JDK version used: 
 * @Author: 申午武
 ...
 * @Version: 1.0
 */
public class ExamineRequest extends Reserve implements Serializable {

	private static final long serialVersionUID = 729293522323005062L;
	/**
	 ...
	 * @param endDate
	 */
	public ExamineRequest(String branchCode, String patCardType, String patCardNo, String admissionNo, String beginDate, String endDate) {
		super();
