	...
	$.extend(Modal.prototype, {
		show: function() {
			...
			if (this.options.mleft !== undefined) {
				this.$modal.css({'margin-left': this.options.mleft});
			}else{
                this.$modal.css({'margin-left': '-'+this.$modal.width()/2+'px'});
            }
			...
			if (this.options.remote !== undefined && this.options.remote != '' && this.options.remote !== '#') {
                ...
                if(typeof this.options.remote =='object'){
                    this.$modal.find('.inner').load(self.options.remote.url,self.options.remote.data || '' ,self.options.remote.fun)
