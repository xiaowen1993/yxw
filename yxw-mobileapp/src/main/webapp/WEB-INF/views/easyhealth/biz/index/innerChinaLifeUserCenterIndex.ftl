...
<div id="body">
    <div id="myCenter">
		...
		<ul class="yx-list listRow" >
          ...
          <#--  <li class="arrow" onclick="go('http://pt.yx129.cn:8009/api/claimIndex?openId=${sessionUser.id}&appCode=${appCode}&areaCode=${areaCode}', true)"><i class="lipei icon-wodelipei" style="font-size: 40px; vertical-align: middle;color: #ff9446 "></i>理赔专区</li> -->
		
		    <li class="arrow" onclick="go('http://localhost:8009/api/claimIndex?openId=${sessionUser.id}&appCode=${appCode}&areaCode=${areaCode}', true)"><i class="lipei icon-wodelipei" style="font-size: 40px; vertical-align: middle;color: #ff9446 "></i>理赔专区</li>
