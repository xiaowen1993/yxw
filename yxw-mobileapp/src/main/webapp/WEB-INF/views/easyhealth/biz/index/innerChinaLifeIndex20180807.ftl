...
<body ontouchend="">
    <div id="body" v-cloak="">
        <div id="home">
						...
						<#list carrieroperators2 as carrieroperator>
							<div class="swiper-slide">
								<#if carrieroperator.contentType == "url">
			                    	<img src="${carrieroperator.shufflingPic}" data-href="${carrieroperator.content}" width="100%" >
			                    <#else>
            ...
            <div class="enter t">
                ...
                <a href="javascript:go('http://pay.yx129.cn/pay/test/unionpay', true)">
    ...
    <script>
        require(['vue', 'jq', 'swiper'], function (Vue, jQ, Swiper) {
			...
			$('.swiper-slide img').height(window.innerWidth / 2.72);
