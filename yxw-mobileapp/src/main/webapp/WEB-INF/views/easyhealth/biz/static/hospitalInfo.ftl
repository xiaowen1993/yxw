...
<div id="body">
    <div id="Hospital-list">
        ...
        <!--
        <li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=735')">
            <div class="pic">
        ...
        <li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=731')">
            <div class="pic">
        ...
        <li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=738')">
            <div class="pic">
       ...
       <!--<li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=729')">
        ...
        <!--  <li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=736')">
         ...
         -->
         <!--<li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=737')">
            <div class="pic">
       ...
       <!-- <li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=733')">
            <div class="pic">
        ...
        <li class="arrow" onclick="go('http://wx.yx129.net/show.php?pid=728')">
            <div class="pic">
