...
<form id="voForm" method="post" action="${basePath}easyhealth/register/doctorTime/index">
...
<script type="text/javascript">
	...
	function loadHistoryRegDoctors() {
		...
		var url = appPath + 'app/usercenter/getHistoryDoctors';
		var now = new Date();
		...
		$.ajax({
			...
			error: function(XMLHttpRequest, textStatus, errorThrown) {
				...
				$('#voForm').attr('action', '${basePath}app/usercenter/historyRegDoctor/index?timeTemp=' + timeTemp);
				$('#voForm').submit();
			},
