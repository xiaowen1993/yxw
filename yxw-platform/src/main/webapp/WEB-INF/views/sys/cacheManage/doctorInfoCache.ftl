                        ...
                        <table class="table table-bordered table-textCenter table-striped table-hover" >
                            <tbody>
                                <tr>
                                    ...
                                    <td width="88%">
                                        <textarea style="width:100%;height:650px;" class="textarea-pay" readonly="readonly">${curDoctorInfos}</textarea>
                                    </td>
                                </tr>
                        ...
                        <table class="table table-bordered table-textCenter table-striped table-hover" >
                            <tbody>
                                <tr>
                                    <td width="10%">医生信息缓存</td>
                                    <td width="88%">
                                        <textarea style="width:100%;height:650px;" class="textarea-pay" readonly="readonly">${regDoctorInfos}</textarea>
                                    </td>
                                </tr>
