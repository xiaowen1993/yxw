...
<#include "/sys/common/common.ftl">
    <script type="text/javascript" src="${basePath}js/sys/cache/sys.cache.js?version=2"></script>
    <title>医院科室缓存</title>
    <style>
    .table th, .table td {
        padding: 5px 2px;
                        ...
                        <table class="table table-bordered table-textCenter table-striped table-hover" >
                            <tbody>
                                <tr>
                                    ...
                                    <td width="88%">
                                        <textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${curLevelOneDepts}</textarea>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${curLevelTwoDepts}</textarea>
                                    </td>
                                </tr>
                                </#if>
                                <tr><td colspan="2"><button class="btn btn-save" type="button" onclick="cacheJS.reLoadDataToCache('2')">获取新数据</button></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-textCenter table-striped table-hover" >
                            <tbody>
                                <tr>
                                    <td width="10%">一级科室缓存</td>
                                    <td width="88%">
                                        <textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${regLevelOneDepts}</textarea>
                                    </td>
                                </tr>
                                <#if levelTwoDepts?exists>
                                <tr>
                                    <td width="10%">二级科室缓存</td>
                                    <td>
                                        <textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${regLevelTwoDepts}</textarea>
                                    </td>
                                </tr>
                                </#if>
                                <tr><td colspan="2"><button class="btn btn-save" type="button" onclick="cacheJS.reLoadDataToCache('1')">获取新数据</button></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
