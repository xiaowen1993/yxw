            ...
            <div class="widget-box">
                ...
                <div class="widget-content ">
                    <div class="row-fluid">
                        ...
                        <div class="rule-msg">
                            <div class="r-title ruleBg">
                                <ul class="tab_navs">
                                    ...
                                    <li class="tab_pic"><a href="javascript:void(0);" onclick="$msg.addPic(this,'${hospitalId}');">图片</a></li>
                        ...
                        <div class="clearfix">
                            <button type="button" class="btn btn-save" id="saveBtn" onclick="$msg.saveReply(1,'${hospitalId}');">保存</button>
