...
<#include "./sys/common/hospital_setting.ftl">
    <div id="content-header">
        <div class="widget-title"><h3 class="title"><#if flagTime==null><a href="${request.contextPath}/message/reply?method=toFocusedReply&hospitalId=${hospitalId}" class="green">返回</a>　｜　</#if>新建多图文消息</h3></div>
    </div>
            ...
            <div class="widget-box">
                <div class="text-msg">
                    <div class="t-msg">
                        <div class="inner js_msg_item">
                            <div class="multi-thumb">
                                ...
                                <div class="msg-edit-mask"><a class="icons_edit edit-white a_item" href="javascript:void(0)"  onClick="$msg.js_edit_line(this)"></a></div>
                            </div>
                        </div>
                        <div class="msg-out clearfix">
                             <div class="inner msg-item js_msg_item">
	                            ...
	                            <div class="msg-edit-mask">
	                                <a class="icons_edit edit-white a_item" href="javascript:void(0)"  onClick="$msg.js_edit_line(this)"></a>
	                                <div class="spaceW9"></div>
	                                <a class="icons_edit del-white" href="javascript:void(0)" onclick="$msg.delThisWhite(this);"></a>
	                            </div>
                       		 </div>
                        </div>
                    ...
                    <div class="t-margin">
                        ...
                        <div class="space20"></div>
                        <button type="button" class="btn btn-save w130" onclick="$msg.saveMutlti('${hospitalId}',${type},${index},'${flagTime}','${thirdType}');">保存</button>
                    </div>
                </div>
            </div>
        </div>
