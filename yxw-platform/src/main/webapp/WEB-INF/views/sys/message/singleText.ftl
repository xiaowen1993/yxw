...
<#include "./sys/common/hospital_setting.ftl">
    <div id="content-header">
        <div class="widget-title"><h3 class="title"><#if flagTime==null><a  href="${request.contextPath}/message/reply?method=toFocusedReply&hospitalId=${hospitalId}"  class="green">返回</a>　｜　</#if>新建单图文消息</h3></div>
    </div>
            ...
            <div class="widget-box">
                <div class="text-msg">
                    ...
                    <div class="t-margin">
                        ...
                        <div class="space20"></div>
                        <button type="button" class="btn btn-save w130" onclick="$msg.saveSingle('${hospitalId}',${type},${index},'${flagTime}','${thirdType}');" >保存</button>
                    </div>
                </div>
            </div>
        </div>
