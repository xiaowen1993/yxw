...
<div class="widget-content">
    <div class="row-fluid">
        <div class="controls center"><button type="button" class="btn btn-save w260 h48"  id="singleBtn">添加单图文消息</button></div>
        <div class="space15"></div>
        <div class="controls center"><button type="button" class="btn btn-save w260 h48" id="multiBtn">添加多图文消息</button></div>
        <div class="space15"></div>
