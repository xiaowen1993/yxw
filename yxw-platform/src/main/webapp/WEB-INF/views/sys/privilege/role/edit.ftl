...
<script type="text/javascript" src="${basePath}js/sys/privilege/role/sys.role.js?00"></script>
</head>
<body>
<!--content str-->
<#include "./sys/common/hospital_setting.ftl">
    ...
    <div id="content-header">
        <div class="widget-title"><h3 class="title">编辑角色</h3></div>
    </div>
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <form>
	                ...
	                <div class="widget-content">
	                    <div class="row-fluid">
	                            <div class="control-group">
	                            	...
	                            	<div class="controls"><input class="span4" type="text" value="${role.name}" name="name" id="name"/></div>
	                            </div>
	                            <div class="control-group">
	                            	<h4 class="title">编码</h4>
	                            	<div class="controls"><input class="span4" type="text" value="${role.code}" name="code" id="code"/></div>
	                            </div>
	                            <div class="control-group">
	                            	<h4 class="title">是否可用</h4>
	                            	<div class="controls">
	                            		<#if role?? && role.available==1 >
	                            ...
	                            <div class="control-group">
	                            	...
	                            	<div class="controls">
	                            		<input class="span4" type="text" value="${role.memo}" name="memo" id="memo"/>
	                           		</div>
	                            </div>
	                	</div>
	                </div>
	                            ...
	                            <div class="control-group">
	                            	...
	                            	<div class="controls" style="overflow-y:scroll;width:100%;height:550">
	                            		<table class="table table-bordered table-textCenter table-striped table-hover">
				                            ...
				                            <tr>
				                               <th width="50">
													<#if resourceList?size==checkResourceIdSet?size>
				                            ...
				                            <#if (resourceList?size>0)>
					                            <tbody>
						                                ...
						                                <tr>
						                                    <td>
						                                    	<#if checkResourceIdSet?? && checkResourceIdSet?seq_contains(resource.id) >
								                            		<label class="checkboxTwo inline check">
						                                    			<input type="checkbox" name="resourceIds" value="${resource.id}" checked="checked"/>
																	</label>
																	<#else>
                ...
                <div class="controls">
                    <button class="btn btn-save" type="button" onclick="$role.edit();">更新</button>
