...
<#include "./sys/common/hospital_setting.ftl">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="pull-left">
                   <a href="${basePath}message/mixedMeterial?method=list&hospitalId=${hospitalId}"><button type="button" class="btn btn-ok w130 active">图文消息</button></a> 
                   <a href="${basePath}message/meterial?method=listOfPic&hospitalId=${hospitalId}"><button type="button" class="btn btn-ok w130 ">图片库</button></a>
                </div>
                ...
                <div class="widget-content" style="padding: 0;">
                    <div class="row-fluid">
                        <div class="upload-box">
                            <a class="btn-add pull-right" href="javascript:void(0);" onclick="showMenu(this);"><i class="caret"></i><i class="icons-plus"></i>添加</a>
                            <div class="menu-box">
                                <a href="#" class="btn btn-save" onclick="$meterial.addSingle('${hospitalId}');">单图文消息</a>
                                <div class="space20"></div>
                                <a href="#" class="btn btn-save" onclick="$meterial.addMixed('${hospitalId}');">多图文消息</a>
                            </div>
                        </div>
                    </div>
                </div>
                            	...
                            	<#list mixedMeterials.list as mixedMeterial>
                            		<#if mixedMeterial.type==1>
                            			<div class="t-msg">
		                                    ...
		                                    <div class="options">
		                                        <div class="btn-tool first" onclick="$meterial.editSingle('${mixedMeterial.id}','${hospitalId}');"><i class="icons-edit"></i>编辑</div>
		                                        <div class="btn-tool" onclick="$meterial.deleteMixed('${mixedMeterial.id}');"><i class="icons-trash"></i>删除</div>
		                                    </div>
		                                </div>
                            		<#else>
                            			 <div class="t-msg">
		                                    ...
		                                    <div class="options">
		                                        <div class="btn-tool first"  onclick="$meterial.editMixed('${mixedMeterial.id}','${hospitalId}');"><i class="icons-edit"></i>编辑</div>
		                                        <div class="btn-tool" onclick="$meterial.deleteMixed('${mixedMeterial.id}');"><i class="icons-trash"></i>删除</div>
		                                    </div>
		                                </div>
                            		</#if>
