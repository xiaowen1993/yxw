            ...
            <div class="widget-box">
                <div class="text-msg">
                    ...
                    <div class="t-margin">
                        ...
                        <i class="caret"></i>
                        <div class="inner">
                            <div class="control-group"><h4 class="title">标题</h4><div class="controls"><input maxlength="30" class="span6 js_title" type="text" id="title"  oninput="OnInput(event)" onpropertychange="OnPropChanged(event)"  value="${mixedMeterial.title}"/></div></div>
                            <div class="control-group"><h4 class="title">作者<small class="green">(选填)</small></h4><div class="controls"><input  maxlength="20" class="span6" type="text" value="${mixedMeterial.author}" id="author"/></div></div>
                            ...
                            <div class="control-group"><h4 class="title">摘要<small class="green">(选填)</small></h4>
                                <div class="controls">
                                    <textarea class="span12 js_desc" rows="3"  id="description" maxlength="51">${mixedMeterial.description}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="space20"></div>
                        <button type="button" class="btn btn-save w130" onclick="editMulti();">保存</button>
                    </div>
                </div>
            </div>
        </div>
