 ...
 * @Version: 1.0
 */
public interface RuleOnlineFilingService extends BaseService<RuleOnlineFiling, String> {
	/**
	 * 保存
	 * @param ruleOnlineFiling
	 * @return
	 */
	public String saveRuleOnlineFiling(RuleOnlineFiling ruleOnlineFiling);
