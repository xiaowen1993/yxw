...
package com.yxw.framework.common.eventsource;
...
* 
* @param emitter
*            the {@link Emitter} instance that allows to operate on the connection
* @throws IOException
...
*//**
* <p>
* Callback method invoked when an event source connection is resumed by the client after the client lost the
* connection to the server.
* </p>
* 
* <p>
* Servers who don't care about the last event id can implement this method in terms of {@link #onOpen(Emitter)}.
* 
* <pre>
* <code>
...
*            the {@link Emitter} instance that allows to operate on the connection
* @param lastEventId
*            the last event id the client received
* @throws IOException
*             if the implementation of the method throws such exception
*/
/*
...
*//**
* <p>
* Sends an id to the client.
* </p>
* <p>
* When invoked as: <code>comment("id")</code>, the client will receive the line:
* </p>
* 
* <pre>
* id: foo
* </pre>
* <p>
* This method has to be invoked before {@link #data(String)} or {@link #event(String, String)}.
* </p>
* 
