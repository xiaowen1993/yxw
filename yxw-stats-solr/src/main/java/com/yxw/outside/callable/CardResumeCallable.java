...
public class CardResumeCallable implements Callable<Map<String, Object>> {
	
	private Logger logger = LoggerFactory.getLogger(CardResumeCallable.class);
	...
	public Map<String, Object> call() throws Exception {
		...
		resultMap.put(OutsideConstants.CARD_INFOS, statsMap);
