...
public class ClinicResumeCallable implements Callable<Map<String, Object>> {
	
	private Logger logger = LoggerFactory.getLogger(ClinicResumeCallable.class);
	...
	public Map<String, Object> call() throws Exception {
		...
		try {
			...
			logger.error("获取门诊概要统计数据异常. errorMsg: {}. cause: {}.", new Object[] { e.getMessage(), e.getCause() });
		}
		
		resultMap.put(OutsideConstants.CLINIC_INFOS, statsMap);
