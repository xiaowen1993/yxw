...
public class SubscribeDatasCallable implements Callable<Map<String, Object>> {
	
	private Logger logger = LoggerFactory.getLogger(SubscribeDatasCallable.class);
	...
	public SubscribeDatasCallable(String areaCode, String hospitalCode, String beginMonth, String endMonth) {
