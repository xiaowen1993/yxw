...
public class AgeGroupDatasCallable implements Callable<Map<String, Object>> {
	
	private Logger logger = LoggerFactory.getLogger(AgeGroupDatasCallable.class);
	...
	public AgeGroupDatasCallable(String areaCode, String hospitalCode, String beginMonth, String endMonth) {
	...
	public Map<String, Object> call() throws Exception {
		...
		try {
			...
			logger.error("获取年龄段统计数据异常. errorMsg: {}. cause: {}.", new Object[] { e.getMessage(), e.getCause() });
		}
