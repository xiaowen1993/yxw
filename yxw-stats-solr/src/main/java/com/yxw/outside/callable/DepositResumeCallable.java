...
public class DepositResumeCallable implements Callable<Map<String, Object>> {
	
	private Logger logger = LoggerFactory.getLogger(DepositResumeCallable.class);
	...
	public Map<String, Object> call() throws Exception {
		...
		// solrQuery.addStatsFieldFacets(null, "areaName");  // 按区域
		...
		try {
			...
			logger.error("获取押金概要统计数据异常. errorMsg: {}. cause: {}.", new Object[] { e.getMessage(), e.getCause() });
		}
		
		resultMap.put(OutsideConstants.DEPOSIT_INFOS, statsMap);
