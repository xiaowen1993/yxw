...
public class DepositDatasCallable implements Callable<Map<String, Object>> {
	
	private Logger logger = LoggerFactory.getLogger(DepositDatasCallable.class);
	...
	public DepositDatasCallable(String areaCode, String hospitalCode, String beginMonth, String endMonth) {
	...
	public Map<String, Object> call() throws Exception {
		...
		try {
			...
			resultMap.put(Cores.CORE_STATS_DEPOSIT, statsMap);
		} catch (Exception e) {
			logger.error("获取押金统计数据异常. errorMsg: {}. cause: {}.", new Object[] { e.getMessage(), e.getCause() });
		}
