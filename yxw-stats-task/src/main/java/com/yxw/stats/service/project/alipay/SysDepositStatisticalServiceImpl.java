...
@Service(value = "alipaySysDepositStatisticalService")
public class SysDepositStatisticalServiceImpl implements SysDepositStatisticalService {

	private SysDepositStatisticalDao sysDepositStatisticalDao = SpringContextHolder.getBean("alipaySysDepositStatisticalDao");
