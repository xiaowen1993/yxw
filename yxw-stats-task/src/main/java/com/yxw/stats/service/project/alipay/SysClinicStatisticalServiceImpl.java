...
@Service(value = "alipaySysClinicStatisticalService")
public class SysClinicStatisticalServiceImpl implements SysClinicStatisticalService {

	private SysClinicStatisticalDao sysClinicStatisticalDao = SpringContextHolder.getBean("alipaySysClinicStatisticalDao");
