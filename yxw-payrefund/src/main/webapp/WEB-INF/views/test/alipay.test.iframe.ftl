...
<body>
	<div id="body">
		...
		<#--<form id="myForm" name="myForm" action="${basePath}pay/alipay" method="post">-->
		<form id="myForm" name="myForm" action="${basePath}pay/alipay2d0" method="post">
			<input type="hidden" name="hospitalCode" value="zsdxdsfsyy"/>
			<input type="hidden" name="tradeMode" value="22"/>
			...
			<input type="hidden" name="merchantUrl" value="${basePath}pay/test/info"/>
  		</form>
