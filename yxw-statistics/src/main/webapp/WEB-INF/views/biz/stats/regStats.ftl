...
<head>
	...
	<script type="text/javascript" src="${basePath}stats/js/biz/stats/regStats.js"></script>
    ...
    <div id="content-header">
    	<div class="widget-title">
	        <h3 class="title">
	            ...
	            <a href="javascript: void(0);" class="tab active" data-url="stats/reg/index">挂号订单</a> |
