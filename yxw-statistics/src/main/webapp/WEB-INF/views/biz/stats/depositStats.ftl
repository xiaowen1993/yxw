...
<head>
	...
	<script type="text/javascript" src="${basePath}stats/js/biz/stats/depositStats.js"></script>
    ...
    <div id="content-header">
    	<div class="widget-title">
	        <h3 class="title">
	            ...
	            <a href="javascript: void(0);" class="tab active" data-url="stats/deposit/index">住院订单</a> |
...
<form id="voForm" method="post">
	...
	<input type="hidden" name="branchCode" id="branchCode" value="-1" />
