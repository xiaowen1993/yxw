...
<head>
	...
	<script type="text/javascript" src="${basePath}stats/js/biz/stats/clinicStats.js"></script>
    ...
    <div id="content-header">
    	<div class="widget-title">
	        <h3 class="title">
	            ...
	            <a href="javascript: void(0);" class="tab active" data-url="stats/clinic/index">门诊订单</a> |
