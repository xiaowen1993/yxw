...
public class OrderManagerController {
	...
	private OrderManagerService orderManagerService = SpringContextHolder.getBean(OrderManagerService.class);
	
	@RequestMapping("/index")
	public ModelAndView toView(HttpServletRequest request, CommonVo vo) {
		ModelAndView view = new ModelAndView("biz/manager/orderManager");
	...
	public RespBody getOrders(HttpServletRequest request, OrderManagerVo vo) {
		String result = orderManagerService.getOrders(vo);
