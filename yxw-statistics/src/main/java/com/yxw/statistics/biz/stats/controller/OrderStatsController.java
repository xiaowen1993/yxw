...
@Controller
@RequestMapping("stats/order")
public class OrderStatsController {

	private Logger logger = LoggerFactory.getLogger(OrderStatsController.class);
	...
	public ModelAndView showDetail(HttpServletRequest request, StatsVo vo) {
		ModelAndView view = new ModelAndView("biz/stats/orderStats");
	...
	@ResponseBody
	@RequestMapping("/getAccumulativeInfos")
	public RespBody getAccumulativeInfos(HttpServletRequest request, StatsVo vo) {
