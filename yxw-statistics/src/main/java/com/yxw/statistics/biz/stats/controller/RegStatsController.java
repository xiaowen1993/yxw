...
@Controller
@RequestMapping("stats/reg")
public class RegStatsController {

	private Logger logger = LoggerFactory.getLogger(RegStatsController.class);
	
	private RegStatsService statsService = SpringContextHolder.getBean(RegStatsService.class); 
	
	@RequestMapping("/index")
	public ModelAndView showDetail(HttpServletRequest request, StatsVo vo) {
		ModelAndView view = new ModelAndView("biz/stats/regStats");
