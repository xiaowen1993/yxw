...
public class RegisterManagerController {
	...
	private Logger logger = LoggerFactory.getLogger(RegisterManagerController.class);
	
	private RegisterManagerService service = SpringContextHolder.getBean(RegisterManagerService.class);
	
	@RequestMapping("/index")
	public ModelAndView toView(HttpServletRequest request, CommonVo vo) {
		ModelAndView view = new ModelAndView("biz/manager/registerManager");
	...
	public RespBody getOrders(HttpServletRequest request, RegisterManagerVo vo) {
		String result = service.getOrders(vo);
