...
@Controller
@RequestMapping("stats/card")
public class CardStatsController {

	private Logger logger = LoggerFactory.getLogger(CardStatsController.class);
	
	private CardStatsService statsService = SpringContextHolder.getBean(CardStatsService.class); 
	
	@RequestMapping("/index")
	public ModelAndView showDetail(HttpServletRequest request, StatsVo vo) {
		ModelAndView view = new ModelAndView("biz/stats/cardStats");
