...
@Controller
@RequestMapping("stats/regDept")
public class RegDeptStatsController {

	private Logger logger = LoggerFactory.getLogger(RegDeptStatsController.class);
	
	private RegDeptStatsService statsService = SpringContextHolder.getBean(RegDeptStatsService.class); 
	
	@RequestMapping("/index")
	public ModelAndView showDetail(HttpServletRequest request, StatsVo vo) {
		ModelAndView view = new ModelAndView("biz/stats/regDeptStats");
