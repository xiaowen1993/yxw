...
@Controller
@RequestMapping("stats/deposit")
public class DepositStatsController {

	private Logger logger = LoggerFactory.getLogger(DepositStatsController.class);
	
	private DepositStatsService statsService = SpringContextHolder.getBean(DepositStatsService.class); 
	
	@RequestMapping("/index")
	public ModelAndView showDetail(HttpServletRequest request, StatsVo vo) {
		ModelAndView view = new ModelAndView("biz/stats/depositStats");
