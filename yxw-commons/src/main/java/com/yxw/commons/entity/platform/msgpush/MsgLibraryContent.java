 ...
 * @Version: 1.0
 */
public class MsgLibraryContent extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 5857832553590604750L;
	/**
	 * 序号
	 */
	 ...
	 * @param templateId
	 */
	public MsgLibraryContent(Integer sort, String keyword, String value, String node, String fontColor, String tempLibraryId) {
		super();
		this.sort = sort;
