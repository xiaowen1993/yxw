 ...
 * @Version: 1.0
 */
public class MsgTemplateFunction extends BaseEntity implements Serializable {
	 ...
	 * @param sort
	 */
	public MsgTemplateFunction(String templateId, String functionName, String functionType, String functionCode, String sort) {
		super();
