...
public class GS_HHTest_5_3_11_2 {
	...
	private static String buildHospitalFeeDetailInfoRequestJson() {
		...
		//姓名
		hospitalFeeDetailInfo.setName("陈兆銮");
		//性别代码
		...
		//证件号码
		hospitalFeeDetailInfo.setCredentialNum("440103194505292139");
		//出生日期
		hospitalFeeDetailInfo.setBirthday("1945-05-29");
