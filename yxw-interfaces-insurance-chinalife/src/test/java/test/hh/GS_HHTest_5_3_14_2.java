...
public class GS_HHTest_5_3_14_2 {
	...
	private static String buildHospitalSettlementRequestJson() {
		...
		//姓名
		hospitalSettlement.setName("陈兆銮");
		//性别代码
		...
		//证件号码
		hospitalSettlement.setCredentialNum("440103194505292139");
		//出生日期
		hospitalSettlement.setBirthday("1945-05-29");
		//补偿结算方式, 即时、非即时
