...
public class GS_HHTest_5_3_09_1 {
	...
	private static String buildHospitalRegistrationRequestJson() {
		...
		//姓名
		hospitalRegistration.setName("宋子欣");
		//性别代码
		//0 未知的性别; 1 男性; 2 女性; 9 未说明的性别
		hospitalRegistration.setGenderCode("2");
		//证件类型
		hospitalRegistration.setCredentialType("I");
		//证件号码
		hospitalRegistration.setCredentialNum("440114201612101221");
		//出生日期
		hospitalRegistration.setBirthday("2016-12-10");
		//就医唯一识别码
