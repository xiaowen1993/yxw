...
public class GS_HHTest_5_3_11_1 {
	...
	private static String buildHospitalFeeDetailInfoRequestJson() {
		...
		//success 平台流水号：201744010090102484
		...
		//姓名
		hospitalFeeDetailInfo.setName("宋子欣");
		//性别代码
		//0 未知的性别; 1 男性; 2 女性; 9 未说明的性别
		hospitalFeeDetailInfo.setGenderCode("2");
		//证件类型
		hospitalFeeDetailInfo.setCredentialType("I");
		//证件号码
		hospitalFeeDetailInfo.setCredentialNum("440114201612101221");
		//出生日期
		hospitalFeeDetailInfo.setBirthday("2016-12-10");
