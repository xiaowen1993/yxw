...
public class GS_HHTest_5_3_14_3 {
	...
	private static String buildHospitalSettlementRequestJson() {
		...
		//姓名
		hospitalSettlement.setName("彭红星");
		//性别代码
		...
		//证件号码
		hospitalSettlement.setCredentialNum("132931196408132712");
		//出生日期
		hospitalSettlement.setBirthday("1964-08-13");
		//补偿结算方式, 即时、非即时
