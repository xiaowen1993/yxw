...
public class GS_HHTest_5_3_09_5 {
	...
	private static String buildHospitalRegistrationRequestJson() {
		...
		//姓名
		hospitalRegistration.setName("邱鹿鸣");
		//性别代码
		...
		//证件号码
		hospitalRegistration.setCredentialNum("421302200605090016");
		//出生日期
		hospitalRegistration.setBirthday("2006-05-09");
		//就医唯一识别码
