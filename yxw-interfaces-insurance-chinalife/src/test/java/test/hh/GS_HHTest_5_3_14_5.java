...
public class GS_HHTest_5_3_14_5 {
	...
	private static String buildHospitalSettlementRequestJson() {
		...
		//姓名
		hospitalSettlement.setName("邱鹿鸣");
		//性别代码
		...
		//证件号码
		hospitalSettlement.setCredentialNum("421302200605090016");
		//出生日期
		hospitalSettlement.setBirthday("2006-05-09");
		//补偿结算方式, 即时、非即时
