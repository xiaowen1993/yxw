...
public class GS_HHTest_5_3_11_3 {
	...
	private static String buildHospitalFeeDetailInfoRequestJson() {
		...
		//姓名
		hospitalFeeDetailInfo.setName("彭红星");
		//性别代码
		...
		//证件号码
		hospitalFeeDetailInfo.setCredentialNum("132931196408132712");
		//出生日期
		hospitalFeeDetailInfo.setBirthday("1964-08-13");
