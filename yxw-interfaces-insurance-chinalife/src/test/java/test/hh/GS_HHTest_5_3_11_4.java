...
public class GS_HHTest_5_3_11_4 {
	...
	private static String buildHospitalFeeDetailInfoRequestJson() {
		...
		String userId = "36072620140907051X";
		String orderNo = "reg147503411122783824982";
		...
		//姓名
		hospitalFeeDetailInfo.setName("魏桢腾");
		//性别代码
		...
		//证件号码
		hospitalFeeDetailInfo.setCredentialNum("36072620140907051X");
		//出生日期
		hospitalFeeDetailInfo.setBirthday("2014-09-07");
