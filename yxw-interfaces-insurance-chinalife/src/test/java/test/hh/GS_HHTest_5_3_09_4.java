...
public class GS_HHTest_5_3_09_4 {
	...
	private static String buildHospitalRegistrationRequestJson() {
		...
		//姓名
		hospitalRegistration.setName("魏桢腾");
		//性别代码
		...
		//证件号码
		hospitalRegistration.setCredentialNum("36072620140907051X");
		//出生日期
		hospitalRegistration.setBirthday("2014-09-07");
		//就医唯一识别码
