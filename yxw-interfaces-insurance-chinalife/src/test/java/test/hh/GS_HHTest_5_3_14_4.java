...
public class GS_HHTest_5_3_14_4 {
	...
	private static String buildHospitalSettlementRequestJson() {
		...
		//姓名
		hospitalSettlement.setName("魏桢腾");
		//性别代码
		...
		//证件号码
		hospitalSettlement.setCredentialNum("36072620140907051X");
		//出生日期
		hospitalSettlement.setBirthday("2014-09-07");
		//补偿结算方式, 即时、非即时
