...
public class GS_GSTest_5_3_14陈淑碧 {
	...
	private static String buildHospitalSettlementRequestJson() {
		...
		String bankAccountHolder = "陈淑碧";
		String bankAccountNumber = "6212263602062126792";
		
		//521+1558.6
		String tatalAmount = "2079.60";
		...
		//就诊时间
		hospitalSettlement.setMedicalDate("2017-11-20 00:00:00");
		//离院方式
		...
		hospitalSettlement.setLeaveHospitalDiagnosisName("头部外伤");
		//医疗总费用
		hospitalSettlement.setTotalAmount(tatalAmount);
		//离院时间
		hospitalSettlement.setLeaveHospitalDate("2017-11-21 00:00:00");
		//社保结算时间
		hospitalSettlement.setMedicalInsuranceSettleDate("2017-11-21 00:00:00");
		//医院结算时间
		hospitalSettlement.setHospitalSettleDate("2017-11-21 00:00:00");
		//付款对象
