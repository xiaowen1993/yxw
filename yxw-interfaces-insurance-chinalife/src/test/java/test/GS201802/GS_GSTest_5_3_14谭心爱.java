...
public class GS_GSTest_5_3_14谭心爱 {
	...
	private static String buildHospitalSettlementRequestJson() {
		...
		String bankAccountHolder = "谭心爱";
		String bankAccountNumber = "3327059980121060187";
		
		//72.3+1021
		String tatalAmount = "1093.30";
		...
		//就诊时间
		hospitalSettlement.setMedicalDate("2017-10-27 00:00:00");
		//离院方式
		...
		//离院诊断疾病
		hospitalSettlement.setLeaveHospitalDiagnosisCode("R07400");
		hospitalSettlement.setLeaveHospitalDiagnosisName("胸痛");
		//医疗总费用
		hospitalSettlement.setTotalAmount(tatalAmount);
		//离院时间
		hospitalSettlement.setLeaveHospitalDate("2017-10-27 00:00:00");
		//社保结算时间
		hospitalSettlement.setMedicalInsuranceSettleDate("2017-10-27 00:00:00");
		//医院结算时间
		hospitalSettlement.setHospitalSettleDate("2017-10-27 00:00:00");
		//付款对象
